  ...
  return (
    <>
     <footer className="font-sans tracking-wide bg-gray-50 px-5 lg:px-10 pt-5 pb-6 mt-5">
      <div className='grid justify-center ms-auto text-center mb-10'>
      <a href='#'>
            <img src="/rj_logo.png" alt="logo" className='w-36 text-center' />
            <span className="block me-auto mt-3 w-36 h-0.5 bg-themecolor-themebrown"></span>
          </a>
      </div>
      <div className="flex flex-wrap justify-between gap-10">
        ...
        <div className='max-lg:min-w-[140px]'>
        <h4 className="text-gray-800 font-semibold text-base relative max-sm:cursor-pointer">Follow Us On Social Media</h4>
